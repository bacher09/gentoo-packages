...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PackageModel.changelog_hash'
        db.alter_column('packages_packagemodel', 'changelog_hash', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'PackageModel.manifest_hash'
        db.alter_column('packages_packagemodel', 'manifest_hash', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'PackageModel.latest_ebuild'
        db.alter_column('packages_packagemodel', 'latest_ebuild_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['packages.EbuildModel'], null=True, on_delete=models.SET_NULL))

        # Changing field 'PackageModel.metadata_hash'
        db.alter_column('packages_packagemodel', 'metadata_hash', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

    def backwards(self, orm):

        # Changing field 'PackageModel.changelog_hash'
        db.alter_column('packages_packagemodel', 'changelog_hash', self.gf('django.db.models.fields.CharField')(default='NULL', max_length=128))

        # Changing field 'PackageModel.manifest_hash'
        db.alter_column('packages_packagemodel', 'manifest_hash', self.gf('django.db.models.fields.CharField')(default='NULL', max_length=128))

        # Changing field 'PackageModel.latest_ebuild'
        db.alter_column('packages_packagemodel', 'latest_ebuild_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['packages.EbuildModel'], null=True))

        # Changing field 'PackageModel.metadata_hash'
        db.alter_column('packages_packagemodel', 'metadata_hash', self.gf('django.db.models.fields.CharField')(default='NULL', max_length=128))
