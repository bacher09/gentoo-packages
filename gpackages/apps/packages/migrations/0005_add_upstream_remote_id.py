...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RemoteId'
        db.create_table('packages_remoteid', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('type', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('remote_id', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('package', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['packages.PackageModel'])),
        ))
        db.send_create_signal('packages', ['RemoteId'])


    def backwards(self, orm):
        # Deleting model 'RemoteId'
        db.delete_table('packages_remoteid')
